defmodule PentoWeb.UserRegistrationLive do
    ...
    <div class="mx-auto max-w-sm">
      ...
      >
        <.error :if={@check_errors}>
          Oops, something went wrong! Please check the errors below or Password and Confirm Password doesn't match.
        </.error>
  ...
  def handle_event("save", %{"user" =>  %{"confirm_password" => password, "password" => password } = user_params}, socket) do
